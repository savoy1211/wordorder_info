...
print("Test text created!")
t = LMResults(model, test)
t.get_results("LM_n3_(TURKISH_small)_a0.1_OI_train(90)_test(10).txt")
file = open("LM_n3_(TURKISH_small)_a0.1_OI_train(90)_test(90)", "wb")
p.dump(model, file)
print("LM created!")
...
model = NgramModel(train.tokens, alpha=0.1, n=3)
file = open("LM_n3_(TURKISH_small)_a0.1_R_train(90_o)_test(10_i)", "wb")
p.dump(model, file)
print("LM setup complete!")
test = ModulateText(turkish_10, language="turkish", randomize_within_sentence=True)
print("Test text created!")
t = LMResults(model, test)
t.get_results("LM_n3_(TURKISH_small)_a0.1_R_train(90_o)_test(10_i).txt")
